...
import {
    ...
    SITE_SETTINGS_PLATFORM_BRANDING_CAPTION,
    SITE_SETTINGS_PLATFORM_BRANDING_SUB_CAPTION,
...
const Settings = (props: SettingsProps) => {
    ...
    const setSettingsState = (settingsResponse: SiteInfo) => {
        ...
        const settingsResponseWithNullsRemoved = {
            ...
            hideCourseLitBranding:
                settingsResponse.hideCourseLitBranding ?? true,
            lemonsqueezyOneTimeVariantId:
            ...
            >
                <div className="flex flex-col gap-8">
                    ...
                    >
                        ...
                        <div>
                            <PageBuilderPropertyHeader
                                label={SITE_SETTINGS_PLATFORM_BRANDING_CAPTION}
                            />
                        ...
                        <CardHeader>
                            ...
                            <CardDescription className="flex items-center gap-2">
                                ...
                                <span>
                                    ...
                                    <a
                                        className="underline"
                                        href={documentationUrl("/en/schools/set-up-payments")}
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        {DOCUMENTATION_LINK_LABEL}
