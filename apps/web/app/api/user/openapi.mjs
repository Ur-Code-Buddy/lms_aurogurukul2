    ...
    paths: {
        "/api/user": {
            post: {
                ...
                description:
                    "Creates a user in the current school. Call this endpoint on the school domain, for example `https://your-school-domain/api/user`, and authenticate with `x-api-key`. The legacy `apikey` field in the request body is still accepted for backward compatibility.",
            ...
            patch: {
                ...
                description:
                    "Updates a user in the current school. Call this endpoint on the school domain, for example `https://your-school-domain/api/user`, and authenticate with `x-api-key`. Aurogurukul proxy infrastructure resolves the school and injects the internal `domain` header automatically. The legacy `apikey` field in the request body is still accepted for backward compatibility.",
    ...
    components: {
        schemas: {
            ...
            ErrorResponse: {
                type: "object",
                description:
                    "Error payload returned by the Aurogurukul user API. Depending on the code path, the message may appear in `message` or `error`.",
                properties: {
                    message: {
                        type: "string",
                        description:
