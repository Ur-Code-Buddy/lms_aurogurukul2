...
export const SITE_SETTINGS_DEFAULT_TITLE = PRODUCT_NAME;
export const SITE_SETTINGS_PLATFORM_BRANDING_CAPTION =
    `Remove ${PRODUCT_NAME} branding`;
export const SITE_SETTINGS_PLATFORM_BRANDING_SUB_CAPTION = `Hide "Powered by ${PRODUCT_NAME}" on your courses and site.`;
export const SITE_SETTINGS_PAGE_HEADING = "Settings";
export const HEADER_ABOUT_PRODUCT = `About ${PRODUCT_NAME}`;
...
export const SUBHEADER_SECTION_PAYMENT_CONFIRMATION_WEBHOOK =
    `Your payment processor sends out notifications about purchases. ${PRODUCT_NAME} needs these notifications to accurately reflect user purchases. Copy and paste these into your payment processor's webhook settings.`;
...
export const APIKEY_CARD_DESCRIPTION =
    `Using API keys you can interact with the ${PRODUCT_NAME} API and build custom integrations`;
