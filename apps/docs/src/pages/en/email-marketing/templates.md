...
> **Before you start**: If your school is hosted on [aurogurukul.app](https://aurogurukul.app), you need to get approved to send marketing emails. [Request access here](/en/email-marketing/mail-access-request).
...
Aurogurukul will create a new custom template and open its `Manage` screen.
