...
When you delete a community, Aurogurukul performs a comprehensive cleanup:
...
Aurogurukul implements safety measures to ensure proper deletion:
...
2. If issues persist, confirm webhook and subscription state in the provider dashboard and in your deployment logs
...
- Record error details from the dashboard or server logs if you need to troubleshoot or retry
