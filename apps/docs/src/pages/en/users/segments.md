...
Aurogurukul offers an easy way to create new user segments. By default, your account has only one segment called `Everyone` which includes all the users in your school.
