---
title: Themes
description: Introduction to Aurogurukul's Theme Designer
layout: ../../../layouts/MainLayout.astro
---

Aurogurukul's Theme Designer is a powerful tool that allows you to customize the look and feel of your learning platform.
...
Every theme in Aurogurukul comes in two flavors - light and dark mode. This ensures your website looks great regardless of the user's system preferences or time of day.

![Aurogurukul Theme Builder](/assets/pages/themes/theme-builder-home.png)

Currently, themes apply to the public pages of your school. The dashboard uses the system theme for a consistent editing experience. Dashboard theming may be expanded in a future release. The system theme includes a dark mode.
...
System themes are pre-built themes that come with Aurogurukul. These themes are professionally designed and ready to use. They serve as a great starting point for your website's appearance.

Currently, Aurogurukul offers the following system themes:
...
Custom themes are your own creations or modifications of system themes. When you customize a system theme, Aurogurukul automatically creates a copy of it, allowing you to make changes without affecting the original.
...
> When you edit a theme, Aurogurukul remembers it and automatically selects it the next time you open the theme editor.
...
Aurogurukul provides a carefully curated selection of professional fonts, organized into categories:
