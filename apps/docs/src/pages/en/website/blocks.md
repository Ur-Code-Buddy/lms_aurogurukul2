...
Every page in Aurogurukul is made up of various blocks, stacked in a top-to-bottom fashion. Each block serves a unique purpose and can be customized.
...
![Aurogurukul page blocks](/assets/pages/page-builder-blocks.png)

## Blocks

Aurogurukul offers a wide range of page blocks so that you can build all sorts of web pages.
...
3. In the popup text input, enter the URL as shown below and press <kbd>Enter</kbd>.
   ![Create a hyperlink in rich text block](/assets/pages/aurogurukul-text-editor-create-links.gif)
...
Having a mailing list to sell directly to is a dream of every business, big or small. That's why Aurogurukul offers a dedicated block that lets you capture emails. It is also a [shared block](/en/pages/blocks#shared-page-blocks).
...
Embedding content from other websites is a common requirement. Aurogurukul offers a dedicated block that lets you embed content from other websites.
...
Although, Aurogurukul platform should support any embed code, we have tested with the following platforms:
<br />
<br />
...
> If embed code does not work, verify the provider allows embedding and that the snippet is complete.
### [Footer](#footer)
