...
> This concept does not apply if you self-host Aurogurukul. In the self hosted instance, you get **only one school** which cannot be deleted.
...
1. In the Aurogurukul dashboard, select the school you want to delete and click on the drop down button to expand its settings.
