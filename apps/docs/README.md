...
New to Astro? See the [Astro documentation](https://docs.astro.build).
...
[Algolia](https://www.algolia.com/) offers [DocSearch](https://docsearch.algolia.com/) for documentation sites that meet their program criteria. If you are accepted, provide your API key and index name in `src/config.ts` and a search box can appear in your site header.
