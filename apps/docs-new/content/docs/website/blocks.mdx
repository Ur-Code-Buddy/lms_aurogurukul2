...
The following screenshot shows [Header](/website/blocks#header), [Rich Text](/website/blocks#rich-text), [Hero](/website/blocks#hero), and [Grid](/website/blocks#grid) blocks (top to bottom) in action. Different blocks are highlighted in different colors.
...
4. In the button action, enter the URL the user should be taken to upon clicking.
    - If the URL is from your own school, use its relative form, i.e., `/courses`.
    - If the URL is from some external website, use the absolute (complete) URL, i.e., `https://website.com/courses`.
...
1. Add the `Featured` block on your page. See here for how to [add blocks](/website/edit#add-a-block) to a page.
...
Having a mailing list to sell directly to is a dream of every business, big or small. That's why Aurogurukul offers a dedicated block that lets you capture emails. It is also a [shared block](/website/blocks#shared-page-blocks).
...
Now that you have learned about page blocks, it is time to learn how to use them in your pages. See our [edit a page](/website/edit) guide for details.
