...
If your product's title is `Demo Product`, the sales page's [slug](/website/introduction#understanding-page-slug) will be `demo-product` and the sales page's URL will be `/p/demo-product`.
...
2. Select `Edit page` from the `Actions` dropdown. This will open up the [page builder](/website/edit).
...
2. Click on the `Edit page` button. This will open up the [page builder](/website/edit).
...
[Learn how to edit a page](/website/edit).
