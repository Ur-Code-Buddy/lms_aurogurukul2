...
> **Before you start**: If your school is hosted on [aurogurukul.app](https://aurogurukul.app), you need to get approved to send marketing emails. [Request access here](/email-marketing/mail-access-request).
...
- [Send one-off broadcasts](/email-marketing/broadcasts)
- [Create re-usable templates](/email-marketing/templates)
- [Track your email performance with analytics](/email-marketing/analytics)

## Stuck Somewhere?

We are always here for you. Come chat with us in our <a href="https://discord.com/invite/GR4bQsN" target="_blank">Discord</a> channel or send a tweet to <a href="https://x.com" target="_blank">@Aurogurukul</a>.
