...
> Before you self-host: Although we believe in the power of hosting your own software, we still think that buying a subscription to [Aurogurukul](https://aurogurukul.app) will save you a lot of time and money compared with maintaining your own Aurogurukul instance. Check out our [pricing](https://aurogurukul.app/#pricing).

We distribute Docker images for all our services through Docker Hub.

## Hosting on a VPS using Docker

We recommend [Docker Compose](https://docs.docker.com/compose/) for hosting Aurogurukul.
...
If you want to send emails, including magic login links, with Aurogurukul, that is easy to set up as well.
...
If you want to upload media such as images and videos to your school, you need to configure [MediaLit](https://hub.docker.com/r/medialit/medialit). MediaLit powers Aurogurukul's media management and optimization. MediaLit provides a Docker image that you can self-host.
...
If this is too technical for you to handle, Aurogurukul's hosted version is available at [Aurogurukul.app](https://aurogurukul.app).

It is managed by the team behind Aurogurukul. We take care of everything, so you can focus on your team and content.
