...
Similarly, you can break down your course into `Lessons` and group the lessons into [Sections](/courses/section).
...
6. Embed
    ...
    See the [guide to add an embed](/lessons/embed).

7. Quiz

    For quizzing your students. You can create graded and non-graded quizzes.

    See the [guide to add a quiz](/lessons/add-quiz).

8. SCORM

    For sharing SCORM packages.

    See the [guide to add a SCORM package](/lessons/scorm).
