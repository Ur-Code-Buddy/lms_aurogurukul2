...
2. Compose your email. Learn more about the email composition interface [here](/email-marketing/broadcasts#compose-your-email).
...
Learn how to [sell digital downloads](/downloads/create).
