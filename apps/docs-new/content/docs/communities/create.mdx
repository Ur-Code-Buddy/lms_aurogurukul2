...
Before you can start building your community, you need to set up a school. [Follow this guide](/schools/create) to get yourself a free account and create a school, if you haven't already.
...
- [Manage members](/communities/manage-members)
- [Moderate content](/communities/manage-reported-content)
