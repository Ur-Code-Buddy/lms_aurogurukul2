...
const quickLinks = [
    ...
    {
        title: "Features",
        description: "Explore all the features Aurogurukul offers",
    ...
    {
        title: "Self-Hosting",
        description: "Host Aurogurukul on your own infrastructure",
    ...
    {
        title: "Developers",
        description: "Integrate Aurogurukul with your applications",
